...
export default function UserDropdown({ currentUser }) {
  ...
  const formSettings = () => {
    window.open('https://forms.office.com/Pages/DesignPageV2.aspx?origin=NeoPortalPage&subpage=design&id=aF0ZCJABuEeDRLFy8jzpxXVc9eZWYidNnx-4ODfdvl5UNUlXSjRKNFYxNVdXS1paVUs2SlBGTDU0RS4u&analysis=true');
  };
  const summaryLink = () => {
    window.open('https://forms.office.com/Pages/AnalysisPage.aspx?AnalyzerToken=f2j5VarGBUXWKzCjW4kIZr93rYbgKsAn&id=aF0ZCJABuEeDRLFy8jzpxXVc9eZWYidNnx-4ODfdvl5UNUlXSjRKNFYxNVdXS1paVUs2SlBGTDU0RS4u');
  };
